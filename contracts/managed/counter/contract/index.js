...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      reveal_secret: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`reveal_secret: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const secret_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('reveal_secret',
        ...
        const result_0 = this._reveal_secret_0(context,
                                               partialProofData,
                                               secret_0);
    ...
    this.impureCircuits = { reveal_secret: this.circuits.reveal_secret };
    this.provableCircuits = { reveal_secret: this.circuits.reveal_secret };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('reveal_secret', new __compactRuntime.ContractOperation());
  ...
  _reveal_secret_0(context, partialProofData, secret_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
